...
async function buildPdfInvoice(row: Record<string, unknown>): Promise<Buffer> {
  // Build HTML invoice, return as a simple text-based PDF substitute using raw PDF generation
  // We'll use a simple approach: generate HTML and convert via a basic PDF writer
